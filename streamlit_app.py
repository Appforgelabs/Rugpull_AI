...
if tab_seas is not None:
    with tab_seas:
        ...
        st.caption("Monthly-return seasonality, five complete years + current "
                   "(month-to-date), with the 5-year average per month. "
                   "**Honest framing:** this is price seasonality of the index "
                   "ETFs (n=5 per cell — a weak, noisy tendency), context for "
                   "timing and sizing, never a signal on its own.")
        ...
        for _sym, _label in (("SPY", "S&P 500 (SPY) — Monthly Return Seasonality"),
        ...
        _mn = dt.date.today().month
        st.caption(f"Reading the current month: check the boxed column's 5-yr "
                   f"average and the spread of the five cells beneath it — a "
                   f"consistent sign across years means more than the average; "
                   f"five mixed signs means the average is noise.")
